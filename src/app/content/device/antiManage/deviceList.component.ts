...
export class DeviceListComponent implements OnInit{
  ...
  constructor(private breadcrumbService: BreadcrumbService,private pu:PublicService,
              private deviceListService:DeviceListService,private router:Router){
  ...
  /*添加工程*/
  addDevice(){
    this.router.navigate(['/layout/antiDevices/deviceAdd'])
  }
  /*获取权限*/
  getAuth(){
    ...
    if(!!auth){
      ...
      const addAuth = item['/antiDevices'] ? !!item['/antiDevices'].POST : false;

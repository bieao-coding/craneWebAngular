...
@Component({
  selector:'layout-work',
  templateUrl:'./workdata.component.html'
})
export class WorkDataComponent implements OnInit{
  ...
  localDateComponent(){
    ...
    this.beginTime = this.datePipe.transform(new Date(),'yyyy-MM-dd') + ' 00:00:00';
  ...
  refreshParams():Observable<any>{
    ...
    return this.online.getCraneWorkData(this.projectId,this.crane['craneId'],params);
  }
  /*获取数据*/
  getList(){
